...
# نرم افزار تونسیف
این نرم افزار در واقع کلاینتی است که از قابلیت استفاده از وایرگارد را دارد و تونسیف برای سیستم عامل های مختلف از جمله ویندوز و اندروید و آی او اس کلاینت مجزا دارد.
